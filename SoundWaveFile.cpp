...
HRESULT 
ReadMMIO( HMMIO hmmioIn, MMCKINFO* pckInRIFF, WAVEFORMATEX** ppwfxInfo )
{
...
HRESULT 
WaveOpenFile( CHAR* strFileName, HMMIO* phmmioIn, WAVEFORMATEX** ppwfxInfo, MMCKINFO* pckInRIFF)
{
	HRESULT hr;
	HMMIO   hmmioIn = NULL;
...
HRESULT 
WaveReadFile( HMMIO hmmioIn, UINT cbRead, BYTE* pbDest,MMCKINFO* pckIn, UINT* cbActualRead )
{
...
bool
SoundWaveFile::Read( int size,BYTE* data,UINT* sizeRead)
{
...
void*			
SoundWaveFile::GetWaveRiffChunk()
{
	return m_ckInRiff;
}
